  ...
  try {
    ...
    for (const r of rows) {
      ...
      const valores = [
        String(r['Ano'] || r['ano'] || ''),
        cnj,
        String(r['Nº Inquérito'] || r['Inquerito'] || r['inquerito'] || ''),
        String(r['BO'] || r['bo'] || ''),
        String(r['Natureza Criminal'] || r['Natureza'] || r['natureza'] || ''),
        String(r['Autor'] || r['autor'] || ''),
        String(r['Vítima'] || r['Vitima'] || r['vitima'] || ''),
        String(r['Relatado (Sim/Não)'] || r['Relatado'] || r['relatado'] || 'Não'),
        String(r['COTA - MP solicitou diligências (Sim/Não)'] || r['COTA - MP'] || r['CotaMP'] || 'Não'),
        String(r['Prazo'] || r['prazo'] || ''),
        String(r['Arquivamento'] || r['arquivamento'] || 'Não'),
        String(r['ANP'] || r['anp'] || 'Não'),
        String(r['Denuncia'] || r['Denúncia'] || r['denuncia'] || 'Não'),
        String(r['Objetos Apreendidos'] || r['objetos_apreendidos'] || ''),
        String(r['Pendências'] || r['Pendencias'] || r['pendencias'] || ''),
        `Sim - ${hoje}`
      ];
